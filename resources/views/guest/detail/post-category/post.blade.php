                        ...
                        <div id="post__card" class="bg-transparent rounded-b-lg overflow-hidden md:max-w-md md:h-min">
                            ...
                            <a href="{{ route('posts.show', $post_category->slug) }}" class="no-underline" title="{{ $post_category->title }}">
                                <div class="px-4 pt-4 mb-2">
                                    ...
                                    <div class="space-y-4">
                                        <p class="text-[16px] text-gray-50">{{ $post_category->description }}</p>
                                ...
                                <div class="p-4 flex justify-between items-center mt-auto content-end">
                                    <span class="text-gray-50 font-semibold text-sm">{{ Carbon\Carbon::parse($post_category->created_at)->toFormattedDateString() }}</span>
                                    <span class="text-gray-50 font-semibold text-sm">Read time: {{ $post_category->reading_duration }} Minute</span>
                                </div>
                            </a>
                        </div>
                    @endforeach
