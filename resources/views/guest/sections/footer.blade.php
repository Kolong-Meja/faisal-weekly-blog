    ...
    <div class="w-full mx-auto py-12 px-5">
        <div class="grid grid-cols-1">
            ...
            <ul class="flex w-full justify-center items-center mt-6 space-x-4">
                <li>
                    <a href="https://github.com/Kolong-Meja" class="text-gray-50 hover:text-gray-200 transition-colors duration-300 ease-in-out">
                ...
                <li>
                    <a href="https://twitter.com/EquanimityRF" class="text-gray-50 hover:text-gray-200 transition-colors duration-300 ease-in-out">
                ...
                <li>
                    <a href="https://instagram.com/faisalrmdhn08" class="text-gray-50 hover:text-gray-200 transition-colors duration-300 ease-in-out">
                ...
                <li>
                    <a href="https://www.linkedin.com/in/faisal-ramadhan-9ab18a269" class="text-gray-50 hover:text-gray-200 transition-colors duration-300 ease-in-out">
