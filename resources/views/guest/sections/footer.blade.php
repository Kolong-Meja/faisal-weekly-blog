<footer class="home__footer__section">
    <div class="home__footer__section__container">
        <div class="home__footer__second__div">
            ...
            <div class="home__footer__social__media__block">
                <h3 id="home__footer__social__media__title">Follow Me</h3>
                <ul class="home__footer__social__media__list">
                    <li class="home__footer__social__media__icon">
                        <a href="https://github.com/Kolong-Meja" class="home__footer__social__media__link">
                    ...
                    <li class="home__footer__social__media__icon">
                        <a href="https://twitter.com/EquanimityRF" class="home__footer__social__media__link">
                    ...
                    <li class="home__footer__social__media__icon">
                        <a href="https://instagram.com/faisalrmdhn08" class="home__footer__social__media__link">
                    ...
                    <li class="home__footer__social__media__icon__end">
                        <a href="https://www.linkedin.com/in/faisal-ramadhan-9ab18a269" class="home__footer__social__media__link">
        ...
        <div id="home__footer__border__bottom__inside"></div>
        <p id="home__footer__copyright__content">© 2023 All rights reserved. Faisal Daily Blog.</p>
    </div>
</footer>