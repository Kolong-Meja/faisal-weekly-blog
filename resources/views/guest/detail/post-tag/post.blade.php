                        ...
                        <div id="post__card" class="bg-yellow-400 rounded-b-lg shadow-xl shadow-gray-900/40 overflow-hidden hover:bg-yellow-500 transition-colors duration-300 ease-in-out md:max-w-md md:h-min">
                            ...
                            <a href="{{ route('posts.show', $post_tag->slug) }}" class="no-underline" title="{{ $post_tag->title }}">
                                <div class="px-4 pt-4 mb-2">
                                    ...
                                    <p class="text-[16px] text-gray-900">{{ $post_tag->description }}</p>
                                </div>
                                <div class="p-4 flex justify-between items-center mt-auto content-end">
                                    <span class="text-gray-900 font-semibold text-sm">{{ Carbon\Carbon::parse($post_tag->created_at)->toFormattedDateString() }}</span>
                                    <span class="text-gray-900 font-semibold text-sm">Read time: {{ $post_tag->reading_duration }} Minute</span>
                                </div>
                            </a>
                        </div>
                    @endforeach
