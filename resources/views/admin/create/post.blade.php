                                            ...
                                            <form action="{{ route('post.store') }}" method="POST" class="w-full p-4 bg-zinc-900 rounded-md" enctype="multipart/form-data" autocomplete="on">
                                                ...
                                                <div class="grid grid-cols-2 gap-4">
                                                    <div class="grid grid-rows-5 grid-flow-col gap-y-4">
                                                        ...
                                                        <div>
                                                            <label for="sub_title" class="block mb-2 text-xl font-bold text-yellow-400">Sub Title</label>
                                                            <textarea id="sub_title" rows="6" name="sub_title" class="bg-gray-600 border-2 border-yellow-400 text-white placeholder-gray-400 text-md rounded-lg focus:ring-yellow-500 focus:border-yellow-500 block w-full p-2.5 @error('sub_title') is-invalid @enderror" placeholder="This is my personal story about yesterday..." required></textarea>
                                                            <div class="mt-1 text-sm text-white" id="sub_title_help">Note: Maybe some post need a sub title for clarify the contents of the post itself</div>
                                                        </div>
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="mt-1 text-sm text-white" id="sub_title_help">Note: Meta title is the title that you put on the post page</div>
                                                        </div>
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="mt-1 text-sm text-white" id="sub_title_help">Note: Slug is a sentence that is stored in the url of the website posting page</div>
                                                        </div>
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="mt-1 text-sm text-white" id="sub_title_help">Note: Input keywords that represent the essence of your post</div>
                                                        </div>
                                                    </div>
                                                    <div class="grid grid-rows-5 grid-flow-col gap-y-4">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="mt-1 text-sm text-white" id="user_avatar_help">Note: Upload image to your post is important!</div>
                                                        </div>
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="mt-1 text-sm text-white" id="sub_title_help">Note: Input owner of the image</div>
                                                        </div>
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="mt-1 text-sm text-white" id="sub_title_help">Note: Input URL of the image</div>
                                                        </div>
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="mt-1 text-sm text-white" id="sub_title_help">Note: Press CTRL + click on the tag to unselect.</div>
                                                        </div>
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="mt-1 text-sm text-white" id="sub_title_help">Note: Press CTRL + click on the category to unselect.</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="my-6">
                                                    <label for="content" class="block mb-1 text-xl font-bold text-yellow-400">Content</label>
                                                    <div class="mb-1 text-sm text-white" id="sub_title_help">Note: Share your experience in the form of an interesting story</div>
